    ...
    if (obAmount !== 0) {
      await prisma.ledgerEntry.create({
        data: {
          ...
          debit: balance_type === 'CR' ? Math.round(obAmount * 100) : 0,
          credit: balance_type === 'DR' ? Math.round(obAmount * 100) : 0,
          balance: Math.round(obAmount * 100),
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    // Block delete if customer has outstanding balance
